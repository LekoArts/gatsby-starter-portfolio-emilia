module.exports = {
  ...
  siteTitle: 'Pixart', // Navigation and Site Title
  siteTitleAlt: 'Pixart by NamediaDigital', // Alternative Site title for SEO
  siteTitleShort: 'Pixart', // short_name for manifest
  siteHeadline: 'Publishing & Creating stunning photos', // Headline for schema.org JSONLD
  siteUrl: 'https://pixart.namedia.digital', // Domain of your site. No trailing slash!
